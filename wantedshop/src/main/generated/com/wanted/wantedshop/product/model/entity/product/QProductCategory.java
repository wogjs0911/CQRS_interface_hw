...
public class QProductCategory extends EntityPathBase<ProductCategory> {
    ...
    private static final long serialVersionUID = 1216623838L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProductCategory productCategory = new QProductCategory("productCategory");

    public final com.wanted.wantedshop.product.model.entity.category.QCategory category;
    ...
    public QProductCategory(Class<? extends ProductCategory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new com.wanted.wantedshop.product.model.entity.category.QCategory(forProperty("category"), inits.get("category")) : null;
