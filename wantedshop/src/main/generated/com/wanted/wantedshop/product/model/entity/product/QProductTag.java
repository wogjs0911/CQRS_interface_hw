...
public class QProductTag extends EntityPathBase<ProductTag> {
    ...
    private static final long serialVersionUID = 1269619642L;
    ...
    public final com.wanted.wantedshop.product.model.entity.Tag.QTag tag;
    ...
    public QProductTag(Class<? extends ProductTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tag = inits.isInitialized("tag") ? new com.wanted.wantedshop.product.model.entity.Tag.QTag(forProperty("tag")) : null;
    }
